...
$logo_url = $theme_url.'/assets/img/logo-white.svg';
$wp_foo = 'Designed by <b>DigitlPulse</b>';
...
<!-- wp:areoi/container {"block_id":"7d97df53-d95a-42f7-a9ba-92173536def4","height_dimension_xs":"100","height_unit_xs":"%"} -->
	<!-- wp:areoi/row {"block_id":"b289be32-57b1-4bec-b25e-557f59cacf54","height_dimension_xs":"100","height_unit_xs":"%"} -->
		<!-- wp:areoi/column {"block_id":"ef686268-218d-4087-8b40-9672a7435e8a","col_xs":"col-12","col_md":"col-md-2"} -->
			<!-- wp:image {"lightbox":{"enabled":false},"id":234,"sizeSlug":"large","linkDestination":"custom"} -->
				<figure class="wp-block-image size-large"><a href="<?=$home_url?>"><img src="<?=$logo_url?>" width="100" height="100" class="wp-image-234" /></a></figure>
			<!-- /wp:image -->
		<!-- /wp:areoi/column -->
		<!-- wp:areoi/column {"block_id":"05abf0fd-48b0-46c5-b968-84c96764a0c0","col_xs":"col-12","col_md":"col-md-4"} -->
		...
		<!-- wp:areoi/column {"block_id":"05abf0fd-48b0-46c5-b968-84c96764a0c0","col_xs":"col-12","col_md":"col-md-3"} -->			
			<!-- wp:acf/menuoption {"name":"acf/menuoption","data":{"field_690dfcad101e4":"WP Footer Menu"},"mode":"preview"} /-->		
		<!-- /wp:areoi/column -->
		<!-- wp:areoi/column {"block_id":"a5c2f334-b6da-4885-a37c-cb6d428a48eb","col_xs":"col-12","col_md":"col-md-3"} -->			
			<!-- wp:paragraph {"placeholder":"Column content","className":"foo-contact text-xl-end"} --><p class="foo-contact text-xl-end"><img src="<?=$mail?>" alt="mail" width="22" height="22" />&nbsp;<a href="mailto:<?=$email?>" target="_blank" rel="noreferrer noopener"><strong><?=$email?></strong></a><br><img src="<?=$tel?>" alt="tel" width="22" height="22" />&nbsp;<a href="tel:<?=$tel_url?>" target="_blank" rel="noreferrer noopener"><strong><?=$tel_title?></a></strong></p><!-- /wp:paragraph -->	
	...
	<!-- wp:areoi/row {"block_id":"cdabc16b-3f41-4e16-90b4-6c2b5420392e"} -->
		<!-- wp:areoi/column {"block_id":"8df08636-aba3-4147-9b07-9ac23bd12d90","col_xs":"col-12"} -->
			<!-- wp:paragraph {"placeholder":"Column content","className":"foo-copy"} --><p class="foo-copy">© <?=date("Y")?> <?=$company?> | <a href="https://digitalpulse.click" target="_blank" rel="noreferrer noopener"><?=$wp_foo?></a></p><!-- /wp:paragraph -->
		<!-- /wp:areoi/column -->
	<!-- /wp:areoi/row -->
<!-- /wp:areoi/container -->
<!-- /wp:areoi/strip -->